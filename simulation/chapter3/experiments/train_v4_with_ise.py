...
# 加载滑动窗口环境
env_spec = importlib.util.spec_from_file_location('rl_env_v4', 
    os.path.join(BASE_DIR, 'env', 'rl_env_v4.py'))
env_module = importlib.util.module_from_spec(env_spec)
env_spec.loader.exec_module(env_module)
PlatformRLEnvV4 = env_module.PlatformRLEnvV4
...
class V4SlidingConfig:
    def __init__(self):
        ...
        self.stage1 = {
            ...
            'T1': 8.0,
            'q_des_type': 'constant',
            'save_dir': 'models_v4_with_ise/stage1',
            'actor_lr': 1e-4,
            'critic_lr': 3e-4,
            'patience': 30,
            'sliding_window': 50
        ...
        self.stage2 = {
            ...
            'save_dir': 'models_v4_with_ise/stage2',
            'actor_lr': 1e-4,
            'critic_lr': 3e-4,
            'patience': 40,
            'sliding_window': 50
        ...
        self.stage3 = {
            ...
            'T1': 8.0,
            'q_des_type': 'sinusoidal',
            'save_dir': 'models_v4_with_ise/stage3',
            'actor_lr': 5e-5,
            'critic_lr': 2e-4,
            'patience': 50,
            'sliding_window': 50
...
def train_stage(agent, env_config, stage_name, load_model=None, device='cuda'):
    ...
    print(f"滑动窗口: {env_config['sliding_window']}步")
    ...
    env = PlatformRLEnvV4(
        ...
        sliding_window_size=env_config['sliding_window']
    )
...
def main():
    print("=" * 70)
    print("V4 with ISE 训练")
    print("使用滑动窗口误差奖励代替ISE累积误差")
    print("=" * 70)
